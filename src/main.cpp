...
uint256 hashGenesisBlock("0x91961f644ec61c246a88bfd37bcb423ebf68889bdf6f0c9cdc1fa21b6e1f482b");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // nSubsidy >>= (nHeight / 8400000); // Funcoin: 840k blocks in ~4 years

    // return nSubsidy + nFees;
    int64 nSubsidy = 100 * COIN;

    if (nHeight >= 10 && nHeight <= 163)
    {
        //Premine 3B
        return (500000000 * COIN) + nFees;
    }

    int halvings = nHeight / 23188000;
...
static const int64 nTargetTimespan = 7 * 24 * 60 * 60; // Funcoin: 3.5 days
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xbafd7d8dd566980bc65c6fd2dac9fc86e3fda54461342bea5d801405b881d7cc");
    }
...
bool InitBlockIndex()
{
    ...
    if (!fReindex)
    {
        ...
        // Genesis block
        const char *pszTimestamp = "NO NEW HEADLINES ..! HERE";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char *)pszTimestamp, (const unsigned char *)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 100 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("041284089bf2d19c342494e2d08d2c843a0ff3b8fea4ebc9d1619cdf3f7b693137eb199b2cb8dd1732f1f318b55c16f9a2f04b875e28b7ae1f95bbe7e476e30d0") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime = 1604314093;
        block.nBits = 0x1e0ffff0;
        block.nNonce = 2085892244;

        if (fTestNet)
        {
            block.nTime = 1604314093;
            block.nNonce = 385837279;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x968b86d3ad18495025e28758eb6903f01252cdae0941130068608cd66f4131fc"));
        block.print();
